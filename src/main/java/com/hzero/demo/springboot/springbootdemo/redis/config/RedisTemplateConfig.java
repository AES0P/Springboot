package com.hzero.demo.springboot.springbootdemo.redis.config;
...
public class RedisTemplateConfig extends CachingConfigurerSupport {
    ...
    public RedisTemplate<String, Object> redisTemplate() {
        ...
        System.out.println("生成自定义 redisTemplate");
    ...
    public StringRedisTemplate stringRedisTemplate(RedisConnectionFactory factory) {
        ...
        System.out.println("生成自定义 stringRedisTemplate");
...
//
//        System.out.println("生成 CacheManager");
