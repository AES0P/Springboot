package com.hzero.demo.springboot.springbootdemo.mybatisplus.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/springboot?useSSL=false&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.hzero.demo.springboot.springbootdemo");
